...
2. Une **plateforme interactive locale en Python / Streamlit** (`app-v7.py`) intégrant cours, calculatrices dynamiques, simulateurs de commandes, annales d'examens et gestionnaire de projet E6.
...
```text
.
├── app-v7.py                    # Application Web Streamlit (Version Ultime)
